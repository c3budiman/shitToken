...
contract("TT", async accounts => {
    ...
    it("minting", async () => {
        ...
        try {
            ...
            assert.equal(error.message, "Returned error: VM Exception while processing transaction: revert DevToken: cannot mint to zero address")
        }
    })
    ...
    it("burning", async () => {
        ...
        try {
            ...
            assert.equal(error.message, "Returned error: VM Exception while processing transaction: revert DevToken: cannot burn from zero address");
        }
        ...
        try {
            ...
            assert.equal(error.message, "Returned error: VM Exception while processing transaction: revert DevToken: Cannot burn more than the account owns")
        }
    ...
    it("transfering tokens", async () => {
        ...
        try {
            ...
            assert.equal(error.message, "Returned error: VM Exception while processing transaction: revert DevToken: cant transfer more than your account holds");
        }
    })
    ...
    it("allow account some allowance", async () => {
        ...
        try {
            ...
            assert.equal(error.message, "Returned error: VM Exception while processing transaction: revert DevToken: approve cannot be to zero address");
        }
    ...
    it("transfering with allowance", async () => {
        ...
        try {
            ...
            assert.equal(error.message, "Returned error: VM Exception while processing transaction: revert DevToken: You cannot spend that much on this account")
        }
